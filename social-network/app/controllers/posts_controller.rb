class PostsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @post.update(post_params)
        format.html { redirect_to user_post_url(@user, @post), notice: "Post was successfully updated." }
  ...
  private
    ...
    def post_params
      params.require(:post).permit(:body, :onlyForFriends, :title)
    end
end
