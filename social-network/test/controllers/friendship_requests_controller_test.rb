...
class FriendshipRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendship_request" do
    assert_difference('FriendshipRequest.count') do
      post friendship_requests_url, params: { friendship_request: { from_user_id: @friendship_request.from_user_id, to_user_id: @friendship_request.to_user_id } }
    end
  ...
  test "should update friendship_request" do
    patch friendship_request_url(@friendship_request), params: { friendship_request: { from_user_id: @friendship_request.from_user_id, to_user_id: @friendship_request.to_user_id } }
